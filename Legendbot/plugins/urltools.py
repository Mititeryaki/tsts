...
@legend.legend_cmd(
    ...
    info={
        ...
        "examples": "{tr}short https://github.com/LEGEND-AI/LEGENDUSERBOT",
    },
)
async def _(event):
...
async def _(event):
    ...
    if str(r.status_code).startswith("3"):
        ...
        await eor(event, f"Input URL {input_str} returned status_code {r.status_code}")
