...
@legend.legend_cmd(
    ...
    info={
        ...
        "examples": "{tr}cbutton test [google]<buttonurl:https://www.google.com> [legenduserbot]<buttonurl:https://t.me/LegendBot_XDS17:same> [support]<buttonurl:https://t.me/LegendBot_OP>",
    },
)
async def _(event):
...
@legend.legend_cmd(
    ...
    info={
        ...
        "examples": "{tr}ibutton test <media:downloads/thumb_image.jpg> [google]<buttonurl:https://www.google.com> [legenduserbot]<buttonurl:https://t.me/LegendBot_XDS17:same> [support]<buttonurl:https://t.me/LegendBot_OP>",
    },
)
async def _(event):
