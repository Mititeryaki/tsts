...
@legend.legend_cmd(
    ...
    info={
        ...
        "examples": "{tr}getc 10 @LegendBot_XDS17",
    },
)
async def get_media(event):
    legendty = event.pattern_match.group(1)
    limit = int(legendty.split(" ")[0])
    channel_username = str(legendty.split(" ")[1])
...
@legend.legend_cmd(
    ...
    info={
        ...
        "examples": "{tr}geta @LegendBot_XDS17",
    },
)
async def get_media(event):
